<div class="space-y-6">
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 px-6 py-5 border-b border-slate-100">
            <div>
                <h2 class="text-base font-bold text-slate-900 tracking-tight">Recover Deleted Accounts</h2>
                <p class="text-sm text-slate-500 mt-0.5">Restore deleted users or permanently remove them.</p>
            </div>
        ...
        <div class="overflow-x-auto">
            <table class="w-full min-w-full">
                ...
                <tr>
                    ...
                    <th class="px-6 py-3.5 text-left text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Deleted At</th>
