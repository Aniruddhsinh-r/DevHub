<div class="space-y-6">
    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
        ...
        <div class="flex items-center gap-3">
            ...
            @endif
            <a href="{{ route('admin.articles.create') }}" wire:navigate class="inline-flex items-center gap-2 h-[44px] px-5 rounded-2xl bg-[#111827] hover:bg-gray-800 text-sm font-black text-white shadow-sm hover:shadow-lg transition-all duration-200">
                <svg xmlns="http://www.w3.org/2000/svg" class="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="3">
            ...
            <div class="bg-white border border-gray-200 rounded-2xl px-4 py-2 shadow-md flex items-baseline gap-2">
                <span class="text-xs text-gray-400 font-bold uppercase tracking-wider">Total Articles:</span>
    ...
    <div class="bg-white border border-slate-200 rounded-2xl shadow-sm overflow-hidden">
        <div class="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4 px-6 py-5 border-b border-slate-100">
            <div>
                <h2 class="text-base font-bold text-slate-900 tracking-tight">All Written Articles</h2>
                <p class="text-sm text-slate-500 mt-0.5">Manage community member articles.</p>
            </div>
                ...
                <table class="w-full min-w-full">
                    <thead class="bg-slate-50/60 border-b border-slate-100">
                        <tr class="border-b border-gray-100 bg-[#fafafa]">
                            <th class="pl-2 py-4 text-xs font-black uppercase tracking-wider text-gray-400 w-12">
                            ...
                            <th class="px-6 py-3.5 text-left text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Article Title</th>
                            <th class="px-6 py-3.5 text-left text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Status</th>
                            <th class="px-6 py-3.5 text-left text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400">Published Time</th>
                            <th class="px-6 py-3.5 text-[11px] font-semibold uppercase tracking-[0.12em] text-slate-400 text-right">Actions</th>
                        </tr>
                    </thead>
