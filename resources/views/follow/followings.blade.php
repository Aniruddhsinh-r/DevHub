        ...
        <div class="space-y-3">
            @forelse ($followings as $following)
                @if ($following->followed)
                    <a href="{{ route('profile.show',$following->followed) }}" wire:navigate class="block group bg-white border border-gray-200 hover:border-gray-400 rounded-2xl px-5 py-4 transition-all duration-300 hover:shadow-xl hover:-translate-y-1">
