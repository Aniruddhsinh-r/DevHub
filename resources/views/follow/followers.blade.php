    ...
    <section class="max-w-3xl mx-auto px-4 py-10">
        <div class="flex items-center justify-between gap-4 mb-8">
            ...
            <form action="" method="GET" class="hidden sm:block">
                <div class="relative">
                    <input type="text" name="follower" value="{{ request('search') }}" placeholder="Search following..." class="w-64 h-11 rounded-2xl border border-gray-200 bg-white pl-4 pr-11 text-sm font-medium text-black placeholder:text-gray-400 focus:outline-none focus:border-black transition-all duration-200">
