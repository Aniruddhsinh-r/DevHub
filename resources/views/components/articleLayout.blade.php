@foreach($articles as $article)
        <a class="group bg-white rounded-[20px] overflow-hidden border border-gray-200 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 cursor-pointer" href="{{ route('articles.show', $article) }}">
