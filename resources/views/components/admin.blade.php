    ...
    <aside class="w-64 md:w-56 sm:w-20 sticky top-16 bg-[#e5e7eb] border-r border-gray-300 flex flex-col justify-between p-4 transition-all duration-300 shrink-0">
        <div>
            ...
            <nav class="flex flex-col gap-1">
                ...
                <a href="/admin/user" class="flex items-center gap-3 p-2.5 rounded-lg cursor-pointer transition-all duration-200 md:justify-start sm:justify-center justify-center {{ request()->is('admin/user*') ? 'bg-white text-gray-900 font-semibold shadow-sm' : 'text-gray-600 hover:bg-white/50 hover:text-gray-900 font-medium' }}">
