...
<div class="max-w-3xl mx-auto my-10 p-6 bg-white border border-gray-200 rounded-2xl shadow-sm">
    ...
    >
        ...
        <div class="mt-10 flex justify-between items-center gap-3">
            <a href="{{ route('profile.index') }}" wire:navigate class="group inline-flex items-center gap-2 text-sm font-extrabold text-gray-500 hover:text-gray-800 transition-colors duration-150">
