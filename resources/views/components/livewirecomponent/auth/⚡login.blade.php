            ...
            <div class="bg-white py-8 px-4 shadow-sm border border-gray-100 sm:rounded-2xl sm:px-10">
                <form wire:submit.prevent="login" class="space-y-5">
                    ...
                    <div class="mt-8 flex items-center justify-between gap-4">
                        <a href="{{ route('password.forgot') }}" wire:navigate class="group inline-flex items-center gap-2 text-sm font-extrabold text-gray-500 hover:text-gray-800 transition-colors duration-150">
                        ...
                        <div>
                            <button type="submit" data-test="login-btn" class="inline-flex justify-center cursor-pointer py-2.5 px-6 border border-transparent rounded-xl shadow-sm text-sm font-semibold text-white bg-indigo-600 hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 transition-all duration-200">
                    ...
                    <div class="text-center pt-1">
                        <p class="text-sm text-gray-500 font-medium">
                            ...
                            <a href="{{ route('register.create') }}" wire:navigate class="font-bold text-indigo-600 hover:text-indigo-500 underline decoration-2 underline-offset-4 transition duration-150">
                                Create an account
                            </a>
                        </p>
                    </div>
