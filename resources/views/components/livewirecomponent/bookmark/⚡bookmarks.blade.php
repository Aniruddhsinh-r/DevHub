...
<div class="py-12 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
    ...
    @if($this->articles->isEmpty())
        <div class="text-center py-20 bg-white rounded-2xl border border-dashed border-gray-300 shadow-sm max-w-md mx-auto">
            ...
            <a href="{{ route('articles.index') }}" wire:navigate class="mt-5 inline-flex items-center px-4 py-2 text-sm font-medium text-white bg-[#1a1a1a] rounded-full hover:bg-gray-800 transition">
                Browse Articles
            </a>
        </div>
    @else
