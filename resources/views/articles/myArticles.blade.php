        ...
        <div class="max-w-7xl mx-auto">
            <div class="flex flex-col md:flex-row md:items-center justify-between mb-10 border-b border-gray-200 pb-8">
                ...
                <div class="mt-4 md:mt-0">
                    <a href="/articles/{{ auth()->user()->id }}/drafts" class="px-6 py-3 rounded-2xl bg-[#111111] text-gray-200 text-sm font-black tracking-wide hover:bg-black transition-all duration-300">
                        draft
                    </a>
                </div>
            </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
                    @foreach($articles as $article)
                        <div class="group bg-white rounded-[20px] overflow-hidden border border-gray-200 shadow-sm hover:shadow-2xl hover:-translate-y-1 transition-all duration-500 relative">
                            <a href="/articles/{{ $article->id }}" class="block relative overflow-hidden h-52">
                            ...
                            <div class="p-4 pt-3">
                                ...
                                <div class="mt-5 flex items-center justify-between border-t border-gray-50 pt-4">
                                    ...
                                    <div class="flex flex-col items-end gap-1">
                                        ...
                                        <a href="/edit/{{ $article->id }}" class="text-xs font-bold text-gray-900 hover:text-black uppercase tracking-wider">
                                            Edit
                                        </a>
                                    </div>
                                </div>
