    ...
    <div class="min-h-screen py-12 px-4 sm:px-6">
        ...
        <div class="max-w-2xl mx-auto">
            ...
            <div class="bg-[#c6caca] rounded-4xl border border-gray-100 shadow-sm overflow-hidden">
                <form x-data="{ status: '{{ old('status', 'published') }}' }" method="POST" action="{{ route('createArticle')}}" class="p-8 md:p-10 space-y-6" enctype="multipart/form-data" enctype="multipart/form-data">
                    @csrf
