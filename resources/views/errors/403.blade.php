...
<body class="bg-[#f8f9fa] text-[#1a1a1a]">
    <div class="min-h-screen bg-black text-white flex items-center justify-center px-6">
        <div class="max-w-xl text-center">
            ...
            <a href="{{ route('filament.app.pages.home') }}" wire:navigate class="inline-flex items-center px-6 py-3 rounded-2xl bg-white text-black font-bold hover:scale-105 transition">Go Home</a>
        </div>
    </div>
</body>
</html>
